...
| `mcp-gateway` | [Capability Model](../architecture/capability-model.md), [Package Map](../architecture/package-map.md), [Test Matrix](test-matrix.md) | `mcp-gateway`, `capability-execution-governance`, `runtime-message-bus`, `testing-regression` |
