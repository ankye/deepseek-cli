...
| R3 Extensibility / 扩展 | `skill-system`, `hook-system`, `mcp-gateway`, `plugin-system`, `extension-system` | canonical skills/hooks v1, manifests, permission diff, lockfile, gateway policy, hook ordering. / canonical skills/hooks v1、manifest、权限 diff、lockfile、gateway policy、hook ordering。 |
