...
| R2 Context And Safety / 上下文安全 | `context-engine`, `memory-cache-management`, `usage-budget-management`, `code-intelligence` | projection, redaction, compaction, budget, sandbox matrix. / projection、redaction、compaction、budget、sandbox matrix。 |
