...
## Purpose
Define communication protocol requirements for host-runtime envelopes, codecs, routing, compatibility, telemetry, and cache-aware metadata.

定义 communication protocol 对 host-runtime envelopes、codecs、routing、compatibility、telemetry 与 cache-aware metadata 的要求。
