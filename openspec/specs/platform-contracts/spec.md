...
## Purpose
Define platform contracts requirements for host-agnostic DTOs, ids, envelopes, errors, service interfaces, and UAPI stability.

定义 platform contracts 对 host-agnostic DTOs、ids、envelopes、errors、service interfaces 与 UAPI stability 的要求。
