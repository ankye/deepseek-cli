...
## Purpose
Define chat TUI workbench interaction requirements for command composition, result actions, rendering, status, and safe execution feedback.

定义 chat TUI workbench interaction 对 command composition、result actions、rendering、status 与安全 execution feedback 的要求。
