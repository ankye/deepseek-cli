...
## Purpose
Define memory and cache management requirements for projection caching, persistent memory references, TTLs, redaction, and runtime integration.

定义 memory and cache management 对 projection caching、persistent memory references、TTLs、redaction 与 runtime integration 的要求。
